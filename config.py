...
#---------------------------------------------------------
modelfile='models/LUCAS_LA_2022.h5'
pickledir='pickles'
outdir='inferenceout/'
indir='indir/'
...
mlprofile={'driver': 'GTiff', 'dtype': 'uint8', 'nodata': 255, 'width': 319, 'height': 327, 'count': 1, 'crs': CRS.from_epsg(2193), 'transform': Affine(0.49036188179562834, 0.0, 1887840.011026467, 0.0, -0.6657987466247166, 5819624.259919928), 'blockxsize': 128, 'blockysize': 128, 'tiled': True, 'compress': 'lzw', 'interleave': 'pixel', 'bigtiff':True}
